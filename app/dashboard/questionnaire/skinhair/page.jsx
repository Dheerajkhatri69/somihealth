...
export default function SkinHairQuestionnaireDashboard() {
            ...
            if (result.success) {
                ...
                if (unseenItems.length > 0) {
                    ...
                    const markAsSeenResponse = await fetch(
                        "/api/skinhair-questionnaire/mark-as-seen",
                        {
                            method: "POST",
    ...
    const filteredData = data.filter((item) => {
        ...
        return searchMatch && filterTreatmentChoose && sexMatch && dateMatch && heardMatch;
    });
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/dashboard/questionnaire/skinhair/${item.authid}`}>
                                                            Open
                                                        </Link>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem asChild>
