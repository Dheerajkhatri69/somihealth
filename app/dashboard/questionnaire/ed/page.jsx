...
export default function EDQuestionnaireDashboard() {
            ...
            if (result.success) {
                ...
                if (unseenItems.length > 0) {
                    ...
                    const markAsSeenResponse = await fetch(
                        "/api/ed-questionnaire/mark-as-seen",
                        {
                            method: "POST",
    ...
    const filteredData = data.filter((item) => {
        ...
        const FilterCurrentMedication =
            filters.currentMedication === "all" ||
            item.currentMedication === filters.currentMedication;
        ...
        return searchMatch && FilterCurrentMedication && sexMatch && dateMatch && heardMatch;
    });
    ...
    return (
        <div className="overflow-x-auto px-4">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                <Select
                    value={filters.currentMedication}
                    onValueChange={(value) =>
                        setFilters((prev) => ({ ...prev, currentMedication: value }))
                    }
                >
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/dashboard/questionnaire/ed/${item.authid}`}>
                                                            Open
                                                        </Link>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem asChild>
