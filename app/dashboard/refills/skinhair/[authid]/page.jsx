...
export default function SkinHairRefillAdminEditForm({ params }) {
    ...
    useEffect(() => {
        const fetchRefillData = async () => {
            ...
            try {
                ...
                const response = await fetch(`/api/skinhair-refill-questionnaire/${params.authid}`);
                ...
                if (data.success && data.result) {
                    ...
                    setFormData({
                        ...
                        phone: refill.phone || '',
                        email: refill.email || '',
                        skinhairApproved: refill.skinhairApproved || '',
                        medicationChanges: refill.medicationChanges || '',
                        medicationChangesDetail: refill.medicationChangesDetail || '',
                        currentTreatment: refill.currentTreatment || '',
                        sideEffects: refill.sideEffects || '',
                        sideEffectsDetail: refill.sideEffectsDetail || '',
                        happyWithTreatment: refill.happyWithTreatment || '',
                        happyWithTreatmentDetail: refill.happyWithTreatmentDetail || '',
                        providerQuestions: refill.providerQuestions || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                try {
                    await fetch("/api/skinhair-refill-abandonment", {
                        method: "POST",
    ...
    return (
        <div className="mb-4 p-4">
            <form onSubmit={handleSubmit} className="w-full space-y-6 p-6 border rounded-xl shadow-sm bg-white">
                <div className="mb-6">
                    <h2 className="text-2xl font-semibold mb-4">Skin/Hair Follow Up</h2>
                    ...
                    <div className="w-full max-w-5xl mx-auto grid grid-cols-1 gap-6 p-6 border rounded-xl shadow-sm bg-[#f0fdf4]">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-4">
                                <label className="flex items-center space-x-2">
                                    <input
                                        type="radio"
                                        name="skinhairApproved"
                                        value="yes"
                                        checked={formData.skinhairApproved === 'yes'}
                                        onChange={handleInputChange}
                                        className="h-4 w-4"
                                    />
                                    <span>Yes</span>
                                ...
                                <label className="flex items-center space-x-2">
                                    <input
                                        ...
                                        name="skinhairApproved"
                                        value="no"
                                        checked={formData.skinhairApproved === 'no'}
                                        onChange={handleInputChange}
                                        className="h-4 w-4"
                                    />
                                    <span>No</span>
                        ...
                        <div className="space-y-2">
                            ...
                            {formData.medicationChanges === 'yes' && (
                                <div className="mt-2">
                                    <Label htmlFor="medicationChangesDetail">Description</Label>
                                    <Textarea
                                        id="medicationChangesDetail"
                                        name="medicationChangesDetail"
                                        value={formData.medicationChangesDetail}
                                        onChange={handleInputChange}
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => handleSelectChange('currentTreatment', value)}
                            >
                                <SelectTrigger>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="Rx Hair">Rx Hair (Finasteride + Biotin)</SelectItem>
                                    <SelectItem value="Rx Skin">Rx Skin (Azelaic acid, Niacinamide, Clindamycin, and Tretinoin)</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        ...
                        {/* Satisfaction */}
                        <div className="space-y-2">
                            <Label>Happy with treatment? *</Label>
                            <div className="flex gap-4">
                                <label className="flex items-center space-x-2">
                                    <input
                                        type="radio"
                                        ...
                                        value="yes"
                                        checked={formData.happyWithTreatment === 'yes'}
                                        onChange={handleInputChange}
                                        className="h-4 w-4"
                                    />
                                    <span>Yes</span>
                                ...
                                <label className="flex items-center space-x-2">
                                    <input
                                        ...
                                        name="happyWithTreatment"
                                        value="no"
                                        checked={formData.happyWithTreatment === 'no'}
                                        onChange={handleInputChange}
                                        className="h-4 w-4"
                                    />
                                    <span>No</span>
                            ...
                            {formData.happyWithTreatment === 'no' && (
                                <div className="mt-2">
                                    <Label htmlFor="happyWithTreatmentDetail">Reason</Label>
                                    <Textarea
                                        id="happyWithTreatmentDetail"
                                        name="happyWithTreatmentDetail"
                                        value={formData.happyWithTreatmentDetail}
                                        onChange={handleInputChange}
                                        className="w-full p-2 border rounded"
                                        rows="3"
                                    />
                        ...
                        {/* Provider Questions */}
                        <div className="space-y-2">
                            <Label htmlFor="providerQuestions">Questions/Concerns for Provider</Label>
                            <Textarea
