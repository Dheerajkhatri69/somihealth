...
import ButtonGroupRefills from "@/components/ButtonGroupRefills";
...
export default function RefillsPage() {
        ...
        try {
            ...
            if (result.success) {
                ...
                if (unseenItems.length > 0) {
                    ...
                    // Mark them as seen
                    const markAsSeenResponse = await fetch('/api/ed-refill-questionnaire/mark-as-seen', {
                        method: 'POST',
    ...
    const filteredData = data.filter(item => {
        ...
        const filterCurrentMedication = filters.currentMedication === 'all' || item.currentMedication === filters.currentMedication;
        ...
        return searchMatch && filterCurrentMedication && dateMatch;
    });
    ...
    return (
        <div className="overflow-x-auto px-4">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                />
                <Select value={filters.currentMedication} onValueChange={(value) => setFilters(prev => ({ ...prev, currentMedication: value }))}>
                    <SelectTrigger className="w-[180px]">
                        <SelectValue placeholder="Current Medication" />
                    </SelectTrigger>
                    <SelectContent>
                    ...
                    <Table>
                        <TableHeader className="bg-secondary">
                            <TableRow className="hover:bg-secondary/80">
                                ...
                                <TableHead className="text-white whitespace-nowrap">Current Medication</TableHead>
                        ...
                        <TableBody>
                            {currentRows.map((item) => (
                                <TableRow key={item._id} className={newlySeenIds.includes(item._id) ? 'bg-green-100 hover:bg-green-200' : 'hover:bg-muted/50'}>
                                    ...
                                    <TableCell className="whitespace-nowrap">{item.currentMedication}</TableCell>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                <DropdownMenuItem asChild>
                                                    <Link href={`/dashboard/refills/ed/${item.authid}`}>
                                                        Open
                                                    </Link>
                                                </DropdownMenuItem>
                                                <DropdownMenuItem asChild>
