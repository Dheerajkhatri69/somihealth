...
export default function Dashboard() {
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                ...
                const patientsRes = await fetch("/api/skinhair-questionnaire");
    ...
    const handleDelete = async (authid, reason) => {
        try {
            const res = await fetch(`/api/skinhair-questionnaire/${authid}`, {
                method: "PUT",
                headers: {
    ...
    return (
        <div className="overflow-x-auto px-4">
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-52">
                                                ...
                                                {(userType === 'A' || userType === 'C') && (
                                                    ...
                                                    >
                                                        <Link href={`/dashboard/questionnaire/skinhair/${patient.authid}`}>Open</Link>
                                                    </DropdownMenuItem>
                                                )}
            ...
            <div className="fixed bottom-4 right-4 flex justify-start items-center gap-4 z-50">
                {(userType === 'A' || userType === 'T') && (
                    <Link href="/dashboard/questionnaire/skinhair/new">
