...
export default function FollowUp() {
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                ...
                const patientsRes = await fetch("/api/ed-refill-questionnaire");
    ...
    async function handleResolveFollowUp(patient) {
        ...
        try {
            const response = await fetch(`/api/ed-refill-questionnaire/${patient.authid}`, {
                method: "PUT",
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-52">
                                                ...
                                                {(userType === 'A' || userType === 'C') && (
                                                    ...
                                                    >
                                                        <Link href={`/dashboard/refills/ed/${patient.authid}`}>Open</Link>
                                                    </DropdownMenuItem>
                                                )}
