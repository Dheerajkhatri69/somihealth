...
export default function FollowUp() {
    ...
    useEffect(() => {
        const fetchPatients = async () => {
            try {
                ...
                const patientsRes = await fetch("/api/longevity-refill-questionnaire");
    ...
    const filteredPatients = patients.filter(patient => {
        ...
        const medicineMatch = medicineFilter === 'all' || patient.preference === medicineFilter;
    ...
    async function handleResolveFollowUp(patient) {
        ...
        try {
            const response = await fetch(`/api/longevity-refill-questionnaire/${patient.authid}`, {
                method: "PUT",
                        ...
                        <TableBody>
                            {currentRows.map((patient) => (
                                <TableRow key={patient.authid} >
                                    ...
                                    <TableCell>{patient.preference}</TableCell>
                                    ...
                                    <TableCell className="whitespace-nowrap">
                                        {patient.dose}{" unit: "}{patient.unit}
                                    </TableCell>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-52">
                                                ...
                                                {(userType === 'A' || userType === 'C') && (
                                                    ...
                                                    >
                                                        <Link href={`/dashboard/refills/longevity/${patient.authid}`}>Open</Link>
                                                    </DropdownMenuItem>
                                                )}
