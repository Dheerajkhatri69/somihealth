...
const PRODUCTS = {
  semaglutide: {
    ...
    options: [
      ...
      {
        label: '8 Weeks (0.25mg and 0.5mg/week) -$279',
        price: '$279',//done
      ...
      {
        label: '12 Weeks (0.25mg, 0.5mg, 1mg/week) -$329',
        price: '$329',//done
  ...
  tirzepatide: {
    ...
    options: [
      ...
      {
        label: '8 Weeks (2.5mg and 5mg/week) -$359',
        price: '$359',//done
      ...
      {
        label: '12 Weeks (2.5mg, 5mg, 7.5mg/week) -$559',
        price: '$559',//done
    ...
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-gradient-to-br from-white to-blue-50 p-4">
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-8 items-start justify-center">
        ...
        <div className="w-full md:w-1/2 bg-white rounded-3xl border border-gray-200 shadow-xl p-6 flex flex-col items-center mb-4 md:mb-0">
          ...
          <h2 className="text-secondary text-xl font-bold mb-4">{product.name}</h2>
          ...
          <div className="space-y-2 mb-4">
            ...
            <div className="flex items-center gap-3 bg-blue-50 border border-blue-100 rounded-lg p-4 max-w-md">
              ...
              <div className="text-sm text-gray-700">
                <strong className="font-semibold">You&apos;re protected:</strong> If you&apos;re not approved by our licensed provider, we&apos;ll refund 100% of your medication and approval fee — no questions asked.
              </div>
            </div>
            <hr />
            <div className="flex justify-between text-gray-700 font-medium">
