            ...
            <div className="p-6 bg-white rounded-xl max-w-[500px] overflow-hidden  border border-gray-200 shadow-secondary shadow-2xl ">
                ...
                <div className="w-full max-w-2xl text-center">
                    ...
                    <div className="relative w-full h-48 sm:h-64 md:h-72 lg:h-80 mx-auto mt-4 mb-6">
                        <Image
                            src="/getstarted.jpg"
                            alt="weighlossrefillwellcomepic"
                            fill
                    ...
                    <p className="text-gray-700 mb-2">
                        We are pleased to see you again and happy to assist you with your refills. Thank you for continuing to trust us with your care.
                    </p>


                    <Link href="/refills/weightloss/questions">
