...
export default function AbandonmentButtonGroup() {
    ...
    const buttons = useMemo(() => [
        ...
        {
            label: "Longevity",
            path: "/dashboard/abandonment/longevity",
            unseenapi: "/api/longevity-abandonment/seen-count"
        },
        {
            label: "Erectile Dysfunction",
            path: "/dashboard/abandonment/ed",
            unseenapi: "/api/ed-abandonment/seen-count"
        },
        {
            label: "Skin and Hair",
