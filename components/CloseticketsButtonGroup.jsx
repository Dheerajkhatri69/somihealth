...
export default function CloseticketsButtonGroup() {
    const pathname = usePathname();

    const buttons = [
        { label: "Weight Loss", path: "/dashboard/closetickets" },
        { label: "Longevity", path: "/dashboard/closetickets/longevity" },
        { label: "Erectile Dysfunction", path: "/dashboard/closetickets/ed" },
        { label: "Skin and Hair", path: "/dashboard/closetickets/skinhair" },
    ];
