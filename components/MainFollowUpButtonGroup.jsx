...
export default function MainFollowUpButtonGroup() {
    const pathname = usePathname();

    const buttons = [
        { label: "Weight Loss", path: "/dashboard/followup" },
        { label: "Longevity", path: "/dashboard/followup/longevity" },
        { label: "Erectile Dysfunction", path: "/dashboard/followup/ed" },
        { label: "Skin and Hair", path: "/dashboard/followup/skinhair" },
    ];
